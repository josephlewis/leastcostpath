...
This vignette describes <b>leastcostpath</b>, a package written for use in the R environment (R Core Team, 2016) and built on classes and functions provided in the R package gdistance (Van Etten, 2017). 
