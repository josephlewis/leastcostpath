leastcostpath <- function(dem, origin, destination, cost_function = "all", direction = FALSE, neighbours = 16, crit_slope = 15, hf = "linear", linear_values = c(-2/180,
    2), binary_values = c(45, 999, 1), forward_values = c(999, 1, 0.5)) {
