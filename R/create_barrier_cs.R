...
#' @details
#'
#' The resultant Barrier Cost Surface is produced by assessing which areas of the raster coincide with the Spatial object as specified in the barrier argument. The areas of the raster that coincide with the Spatial object are given a conductance value of 0 (default value), with all other areas given a Conductance value of 1 (default value). The conductance value of 0 ensures that movement is inhibited within these areas. Examples of use include rivers, altitudes, and taboo areas.
#'
...
#'
#' @param barrier \code{Spatial*} (sp package). Area(s) within the landscape that movement is inhibited. See details for more
#'
...
#'
#' @param field \code{numeric} value. Value assigned to cells that coincide with the barrier SpatialObject. Default is \code{numeric value 0}
#'
