...
PDI_validation <- function(lcp, comparison, reverse = FALSE) {
    ...
    if (reverse) {
        ...
        # origin and destination points of the Least Cost path are snapped to the Origin and Destination points of the comparison SpatialLine. This ensures that the SpatialPolygon
        # that is returned is valid as the Origin and Destination points of the Least Cost Path is the centre of the Raster cell whilst the Origin and Destination of the comparison
        # SpatialLine is not restricted by the Raster Grid.
