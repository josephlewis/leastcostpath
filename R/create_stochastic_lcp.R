...
create_stochastic_lcp <- function(cost_surface, origin, destination, directional = FALSE, percent_quantile) {
    ...
    while (!done) {
        ...
        # replace values lower than threshold_val with 0. Neighbours with higher costs are more likely to be maintained. This is the inverse of stochastic rule noted in Pinto and Keitt (2009)
        # and reflects the cost surface representing conductivity rather than resistance.
