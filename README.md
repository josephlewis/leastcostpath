leastcostpath - version 1.7.9 [![Build Status](https://travis-ci.org/josephlewis/leastcostpath.svg?branch=master)](https://travis-ci.org/josephlewis/leastcostpath)
...
```Error in get.shortest.paths(adjacencyGraph, indexOrigin, indexGoal) : At structural_properties.c:4521 : Weight vector must be non-negative, Invalid value```
...
Please cite as:
    ...
    Lewis, J. (2020) leastcostpath: Modelling Pathways and Movement Potential Within a Landscape (version 1.7.9). 
